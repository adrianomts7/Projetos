...
export default function ListaFaturas({ listaClientes, mostrarMaisInfo, onMostrarMaisInfo, onIsModal, onDadosAcaoForm, dispatch, onConfirmacaoPagouFatura}) {
